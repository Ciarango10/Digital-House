...
// MAP(CALLBACK()) => RECORRE EL ARRAY Y RETORNA UN NUEVO ARRAY MODIFICADO
let notasHastaEl100 = notas.map(function(numero) {
    return numero * 10;
});
console.log(notasHastaEl100);

// FILTER(CALLBACK()) => RETORNA UN ARRAY CON LOS ELEMENTOS QUE CUMPLAN LA CONDICION
let notasAprobadas = notas.filter(function(numero) {
    return numero >= 7;
});
console.log(notasAprobadas);

// REDUCE(CALLBACK(ACUMULADOR, ELEMENTO ACTUAL)) => RECUCIR A LA MAS MINIMA EXPRESION EL ARRAY DADO, RETORNANDO UN UNICO VALOR
